...
------------------------------
The docs are hosted on `GitHub pages`_ at https://jbloomlab.github.io/pdb_prot_align
...
First, clone the repo into ``_build/html/``::
    ...
    mkdir _build
    git clone https://github.com/jbloomlab/pdb_prot_align _build/html
...
After a few minutes, your docs should now show up at https://jbloomlab.github.io/pdb_prot_align
