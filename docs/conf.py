# -*- coding: utf-8 -*-
#
# pdb_prot_align documentation build configuration file.
#
...
versionfile = os.path.abspath(os.path.join(
        os.path.dirname(__file__), '../pdb_prot_align/__init__.py'))
...
htmlhelp_basename = 'pdb_prot_aligndoc'
...
latex_documents = [
    (master_doc, 'pdb_prot_align.tex', u'pdb_prot_align Documentation',
...
man_pages = [
    (master_doc, 'pdb_prot_align', u'pdb_prot_align Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pdb_prot_align', u'pdb_prot_align Documentation',
     author, 'pdb_prot_align', 'Align proteins to PDB chains',
     'Miscellaneous'),
    ]
