...
Package structure
++++++++++++++++++
- Package code is in `pdb_prot_align <pdb_prot_align>`_
- Docs are in docs_
...
https://mybinder.org/v2/gh/jbloomlab/pdb_prot_align/master?filepath=notebooks
...
.. _`__init__.py`: pdb_prot_align/__init__.py
